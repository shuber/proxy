...
class UrlHelperTest < Test::Unit::TestCase
  ...
  def test_should_render_urls_normally
    get :view_action
    assert_equal 'http://example.com/normal_action, /normal_action, /normal_action', @response.body
  end
  ...
  def test_should_render_urls_with_forwarded_hosts_while_respecting_the_only_path_option
    ...
    get :view_action
    assert_equal 'http://domain.com/normal_action, http://domain.com/normal_action, /normal_action', @response.body
  end
  ...
  def test_should_render_urls_with_forwarded_hosts_and_uris
    ...
    @request.env['PATH_INFO'] = '/view_action'
    get :view_action
    assert_equal 'http://domain.com/test/ing/normal_action, http://domain.com/test/ing/normal_action, /test/ing/normal_action', @response.body
  end
